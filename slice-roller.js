...
(function(){
  ...
  + 'background:linear-gradient(180deg,#3a3a3a,#1c1c1c);border:1px solid rgba(255,255,255,.24);'
  ...
  + '.jr-thumb .jr-line{width:16px;height:2px;border-radius:2px;background:rgba(235,235,235,.8);}'
  ...
  + 'background:rgba(15,15,15,.92);color:#ededed;font:700 .74rem/1 Inter,system-ui,sans-serif;'
